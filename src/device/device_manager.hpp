...
namespace vision
{
    ...
    private:
        ...
        ~DeviceManager() = default; ///< Default destructor.
        ...
        FRIEND_TEST(DeviceManager, findDeviceIndex); ///< Test friend declaration.
        ...
        FRIEND_TEST(DeviceManager, checkDevice); ///< Test friend declaration.
    ...
    public:
        ...
        DeviceManager(const DeviceManager&) = delete; ///< Deleting copy constructor.
        DeviceManager& operator=(const DeviceManager&) = delete; ///< Deleting copy assignment operator.
